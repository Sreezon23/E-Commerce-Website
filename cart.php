...
<head>
    ...
    0">
    <title>Web Mart- Cart Details</title>
    <!-- bootstrap CSS link-->
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="./admin_area/product_img/<?php echo $product_image1?>" alt="" class="cart_img"></td>
        ...
        <div class="d-flex mb-5">
            <?php
             ...
             if($result_count>0){
                ...
                <button class='bg-secondary px-3 py-1 border-0'><a href='./users_area/checkout.php' class='text-light text-decoration-none'>
                Checkout</a></button>";
             }else{
