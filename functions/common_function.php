...
$num_of_rows=mysqli_num_rows($result_query);
if($num_of_rows==0){
  echo "<h2 class='text-center text-danger'>No results found. No products found of this category!</h2>";
}
while($row=mysqli_fetch_assoc($result_query)){
  $product_id=$row['product_id'];
  $product_name=$row['product_name'];
  ...
  <!-- related images -->
    <div class='row'>
      <div class='col-md-12'>
        ...
        <div class='col-md-6'>
        <img class='card-img-top' src='./admin_area/product_img/$product_image2' alt='$product_name'>
        </div>
        <div class='col-md-6'>
        <img class='card-img-top' src='./admin_area/product_img/$product_image3' alt='$product_name'>
        </div>
    </div>
</div>    
  </div>";
