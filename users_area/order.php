...
$insert_orders="Insert into `user_orders` (user_id,amount_due,invoice_number,total_products,order_date,order_status) values($user_id,$sub_total,$invoice_number,$count_products,NOW(),'$status')";
